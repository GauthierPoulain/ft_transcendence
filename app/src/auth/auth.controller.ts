import { Controller, Get, Query, Res, Session, Redirect, BadRequestException } from "@nestjs/common";
...
function api42request(
    ...
    return firstValueFrom(httpService.get(new URL(path, api_endpoint).toString(), {
        headers: {
...
export class AuthController {
    ...
    async callback(
        ...
        const { data: { id, login, first_name, last_name, image_url } }
